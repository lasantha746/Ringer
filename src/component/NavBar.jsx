      ...
      <div className="z-[9999] mx-auto flex items-center justify-between flex-wrap">
        ...
        <div className="hidden lg:flex justify-between items-center w-full">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            <Link onClick={(e) => { e.preventDefault(); window.location.href = "/about"; }} className="px-5 py-2 rounded-full text-sm font-medium bg-[#E1E1E1] hover:bg-[#d4d4d4] font-inter font-normal text-base">About</Link>
          </div>
          ...
          <div className="flex gap-2 items-center flex-wrap">
            <Link onClick={(e) => { e.preventDefault(); window.location.href = "/searchPage"; }} className="px-5 py-2  rounded-full text-sm font-medium bg-[#E1E1E1] hover:bg-[#d4d4d4] font-inter font-normal text-base">Search</Link>
