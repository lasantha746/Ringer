                ...
                <div className="min-h-screen bg-[#FAFAFA] flex items-center justify-center px-4 pb-8 pt-8 md:pt-16 md:pb-16">
                    <div className="bg-white w-full md:w-[70%] rounded-[30px] p-5 md:p-10">
                        ...
                        <form className="space-y-4">
                            ...
                            <div className="flex items-center justify-end font-inter font-[400] text-[12px] md:text-[14px] text-[#ED9E53]">
                                <Link to="/recovery" onClick={() => window.scrollTo(0, 0)}>Forgot Password</Link>
                            </div>
                            <div></div>
                            {/* Primary Button */}
                            <button
                        ...
                        <p className="text-center font-poppins font-[400] text-[12px] md:text-[14px] mt-10 text-[#666666]">
                            Don’t have account? <a href="#" className="font-inter font-[500] text-[12px] md:text-[14px] text-[#1A1A1A]"><Link to="/createAccount" onClick={() => window.scrollTo(0, 0)}>Register</Link></a>
                        </p>
                    </div>
                </div>
